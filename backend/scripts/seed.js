...
const reportData = [
  {
    ...
    narrative: "APT29 continued to target government and energy sectors using spear-phishing and MSHTML exploits. Campaign infrastructure reused across multiple victims.",
  ...
  },
  {
    ...
    narrative: "TA505 launched a broad phishing campaign targeting financial institutions using Emotet as initial payload. C2 infrastructure hosted in Eastern Europe.",
  ...
  },
  {
    ...
    narrative: "Multiple threat actors observed exploiting MSHTML RCE vulnerability CVE-2021-40444 in targeted attacks. Metasploit module publicly available.",
  ...
  },
  {
    ...
    narrative: "Domain used as ransomware dropper staging server. Associated with multiple ransomware families including LockBit.",
...
const buildGraph = async (driver) => {
  ...
  const queries = [
    ...
    // Threat actors
    `MERGE (a:ThreatActor {name:'TA505'})   SET a.aliases=['Hive0065','Evil Corp'],         a.origin_country='RU'`,
    `MERGE (a:ThreatActor {name:'APT29'})   SET a.aliases=['Cozy Bear','Midnight Blizzard'],a.origin_country='RU'`,
    `MERGE (a:ThreatActor {name:'LockBit'}) SET a.aliases=['LockBit3'],                     a.origin_country='RU'`,
    // Victim devices
    ...
    // Device → Port → Service → CVE (UC4 exploit chain)
